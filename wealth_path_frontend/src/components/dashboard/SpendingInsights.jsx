    ...
    <DashboardCard>
      <div className="flex flex-col justify-between h-full">
        ...
        <div className="flex w-full items-center justify-between mb-3">
          <div className="text-xl underline mb-3">Monthly Spending Insights:</div>
        </div>
        {/* content */}
        <div className="w-full flex  justify-between">
          {/* piechart */}
          <div
            className="w-[50%] aspect-square rounded-full mr-3"
            style={{
          ...
          <div className="flex flex-col justify-between">
            {/* dropdown */}
            <select className="px-5 py-2 rounded-lg bg-slate-100" onChange={handleChange}>
              {dateRangeSelection()}
            </select>
